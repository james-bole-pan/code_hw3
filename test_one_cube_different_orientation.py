...
def rotation_matrix(axis, theta):
    """
    Returns the rotation matrix for rotating theta radians about axis.
    """
...
# Define the angle and axis for the desired rotation
theta = np.radians(45)  # Rotate by 45 degrees for example
axis_1 = [1, 0, 0]  # Rotate about the x-axis for example
axis_2 = [0, 1, 0]

# Initialize 8 masses for the cube
masses = []
initial_positions = [
    [-half_L0, -half_L0, -half_L0 + drop_height], 
    [half_L0, -half_L0, -half_L0 + drop_height],
    [-half_L0, -half_L0, half_L0 + drop_height],
    [half_L0, -half_L0, half_L0 + drop_height],
    [-half_L0, half_L0, -half_L0 + drop_height],
...
for pos in initial_positions:
    rotated_pos = np.dot(rotation_matrix(axis_1, theta), pos)
    rotated_pos = np.dot(rotation_matrix(axis_2, theta), rotated_pos)
    masses.append(Mass(rotated_pos, [0.0, 0.0, 0.0]))
